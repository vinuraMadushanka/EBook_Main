...
namespace DataAccess.Data.Migrations
{
    ...
    [Migration("20220302055253_Intial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.ApplicationGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Models.ApplicationGroupRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Models.ApplicationUserGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Models.ApplicationGroupRole", b =>
                {
                    b.HasOne("Models.ApplicationGroup", "ApplicationGroup")
                        .WithMany()
                        .HasForeignKey("ApplicationGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Models.ApplicationRole", "ApplicationRole")
                        .WithMany()
